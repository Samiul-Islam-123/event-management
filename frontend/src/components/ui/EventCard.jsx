...
const EventCard = ({ _id, name, description, date, organizer, price, poster, location }) => {
    ...
    return (
        <div style={{ cursor: "pointer" }} onClick={() => navigate(`/app/eventDetails/${_id}`)} className=" w-[290px] h-[360px] rounded-lg flex flex-col overflow-hidden border border-black m-3 shadow-lg shadow-gray-200 bg-white hover:shadow-gray-400 hover:scale-105 transition-all ease-in-out">

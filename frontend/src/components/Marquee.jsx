...
const Marquee = () => {
    ...
    return (
        <div className="marqueeCont scale-[1.3]  w-full h-[65vh] overflow-hidden">
            ...
            <div className="qwigley-regular  mSlides relative scale-[1] w-[90%] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                <div className="lft row -translate-x-1/2 w-full py-5 flex items-center gap-8">
                    <div className="elem flex items-center gap-8">
                        <h1 className='font-semibold  text-6xl opacity-60 '>
                            Events
                        </h1>
                        <div className="imgdiv w-[2.5rem] h-[2.5rem] rounded-full border-[1px] border-[#E167FF]"></div>
                    </div>
                    <div className="elem flex items-center gap-8">
                        <h1 className='font-semibold  text-6xl opacity-60 '>
                            Outings
